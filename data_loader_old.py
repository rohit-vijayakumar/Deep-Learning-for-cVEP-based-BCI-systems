        ...
        if (mode=='within_subject'):
            ...
            for i in range(0,n_subjects):
                ...
                for fold in range(0,15):
                    ...
                    if (model=='eeg2code'):
                        ...
                        data['X_train'] = X_train_epoched
                        data['X_val'] = X_val_epoched
                        data['X_test'] = X_test_epoched
                        data['ys_train'] = Ys_train_epoched
                        data['ys_val'] = Ys_val_epoched
                        data['ys_test'] = Ys_test_epoched
                        data['yt_train'] = yt_train
                        data['yt_val'] = yt_val
                        data['yt_test'] = yt_test

                        with open('./datasets/8_channel_cVEP_within_subject_eeg2code/S{}_f{}.pickle'.format(i+1,fold+1), 'wb') as handle:
            ...
            for i in range(0,n_subjects):
                ...
                if (model=='eeg2code'):
                    ...
                    with open('./datasets/8_channel_cVEP_loso_subject_eeg2code/S{}.pickle'.format(i+1), 'wb') as handle:
                        pickle.dump(data, handle, protocol=pickle.HIGHEST_PROTOCOL)
                ...
                for fold in range(0,15):
                    ...
                    if (model=='eeg2code'):
                        ...
                        with open('./datasets/8_channel_cVEP_loso_subject_eeg2code/S{}_f{}.pickle'.format(i+1,fold+1), 'wb') as handle:
                            pickle.dump(data, handle, protocol=pickle.HIGHEST_PROTOCOL)

                    else:
                        data['X_test'] = X_test
                        data['ys_test'] = Ys_teYs_testst_epoched
                        data['yt_test'] = yt_test
...
datasets = ['8_channel_cVEP','256_channel_cVEP'] #'8_channel_cVEP', '256_channel_cVEP'
modes = ['within_subject','loso_subject'] #'within_subject', 'loso_subject'
model = 'eeg2code'
